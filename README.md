...
| 地图交互主界面 | 水文要素数据统计 | 智能AI助手 |
|:---:|:---:|:---:|
| ![地图交互主界面](./assess/地图交互.png) | ![水文要素数据统计](./assess/水文要素数据统计.png) | ![智能AI助手](./assess/智能助手.png) |
| WebGIS 海洋地图交互与图层控制 | 多维度水文要素指标统计面板 | 内置 AI 智能问答与分析助手 |

### 智能分析预测

| 涡旋识别分析 | 温度趋势预测 | 风浪风险预测 |
|:---:|:---:|:---:|
| ![涡旋识别分析](./assess/涡旋分析.png) | ![温度趋势预测](./assess/温度预测.png) | ![风浪风险预测](./assess/风浪预测.png) |
| 海洋中尺度涡旋自动识别与标注 | 海水温度 72 小时趋势预测可视化 | 海洋风浪异常预警与等级研判 |

| 综合数据统计 |
|:---:|
| ![综合数据统计](./assess/数据统计.png) |
| 全海域多要素综合数据统计与可视化大屏 |
